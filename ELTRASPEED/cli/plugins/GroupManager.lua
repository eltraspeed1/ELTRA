...
if matches[1] == "unmute" and is_mod(msg) or matches[1]=="باز کردن" and is_mod(msg) or matches[1] == "Unmute" and is_mod(msg) then
local target = msg.to.id
 if matches[2] == 'all' or matches[2] == 'همه' then
         local hash = 'muteall:'..msg.to.id
        redis:del(hash)
...
if matches[1] == "lock help" and is_mod(msg) or matches[1] == "Lock help" and is_mod(msg) or matches[1] == "راهنما قفل" and is_mod(msg)then
if not lang then
text = [[
◾️lock help!◾️
﹃﹄﹃﹄﹃﹄﹃﹄﹃﹄﹃﹄
